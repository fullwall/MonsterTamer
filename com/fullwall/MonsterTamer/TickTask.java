...
public class TickTask implements Runnable {
	...
	public TickTask(MonsterTamer plugin) {
		this.plugin = plugin;
	}
	...
	public void run() {
		...
		for (Entry<Integer, Location> entry : MonsterTamer.locationMovers
				.entrySet()) {
			for (LivingEntity le : entry.getValue().getWorld()
					.getLivingEntities()) {
				if (le instanceof Creature
						&& le.getEntityId() == entry.getKey()) {
