...
public class StringUtils {
	public static String pluralise(String string, int size) {
		return size > 1 || size == 0 ? string + "s" : string;
	}

	public static String pluralise(String string, String string2,
			String string3, int size) {
		return size <= 1 ? string2 + string3 : string + string3 + "s";
	}
	...
	public static String defaultListify(String string) {
		return ChatColor.YELLOW + "========[ " + ChatColor.GREEN + string
				+ ChatColor.YELLOW + " ]========";
	}
